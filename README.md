...
- 元のアナログポットと異なり、パラメータは方向キーで段階的に変更します。起動時はSQUARE波形、カーソルはDEPTH、PITCHは440Hz、DEPTHは400Hz、LFO RATEは 1〜80 の 19 です。LFO RATE の範囲は約0.159Hz〜約12.73Hzです。Select 単体でHELPを表示できます。
